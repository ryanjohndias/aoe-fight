    ...
    constructor(units: { [key: string]: Unit; }, upgrades: { [key: string]: Upgrade; }) {
        this.civs = [
            new Civ(10, "Aztecs", "Aztec",
                ...
                [units.champion, units.condottiero, units.eliteEagleWarrior, units.eagleWarrior, units.eliteJaguarWarrior, units.jaguarWarrior, units.xolotl, units.villager, units.pikeman],
            ...
            new Civ(13, "Bulgarians", "Bulgarian",
                ...
                [units.cavalier, units.condottiero, units.eDismountedKonnik, units.dismountedKonnik, units.halbardier, units.eKonnik, units.konnik, units.twoHandedSwordsman, units.villager],
                [upgrades.forging, upgrades.ironCasting, upgrades.blastFurnace],
                [upgrades.scaleMailArmor, upgrades.chainMailArmor, upgrades.plateMailArmor],
                [upgrades.bloodlines, upgrades.scaleBardingArmor, upgrades.chainBardingArmor, upgrades.plateBardingArmor],
                {
            ...
            new Civ(14, "Byzantines", "Byzantine",
                ...
                [units.champion, units.condottiero, units.eCataphract, units.cataphract, units.halbardier, units.hussar, units.heavyCamel, units.paladin, units.villager],
            ...
            new Civ(15, "Burmese", "Burmese",
                ...
                [units.cavalier, units.champion, units.condottiero, units.eBattleElephant, units.battleElephant, units.halbardier, units.hussar, units.villager],
                [upgrades.forging, upgrades.ironCasting, upgrades.blastFurnace],
                [upgrades.scaleMailArmor, upgrades.chainMailArmor, upgrades.plateMailArmor],
                [upgrades.bloodlines, upgrades.scaleBardingArmor, upgrades.chainBardingArmor, upgrades.plateBardingArmor],
            ...
            new Civ(16, "Celts", "Celtic",
                ...
                [units.champion, units.condottiero, units.eWoadRaider, units.woadRaider, units.halbardier, units.hussar, units.paladin, units.villager],
                [upgrades.forging, upgrades.ironCasting, upgrades.blastFurnace],
                [upgrades.scaleMailArmor, upgrades.chainMailArmor, upgrades.plateMailArmor],
            ...
            new Civ(18, "Cumans", "Cuman",
                ...
                [units.camel, units.champion, units.condottiero, units.eSteppeLancer, units.steppeLancer, units.halbardier, units.hussar, units.paladin, units.villager],
                [upgrades.forging, upgrades.ironCasting, upgrades.blastFurnace],
                [upgrades.scaleMailArmor, upgrades.chainMailArmor, upgrades.plateMailArmor],
                [upgrades.bloodlines, upgrades.scaleBardingArmor, upgrades.chainBardingArmor, upgrades.plateBardingArmor],
                {infantry: []}
            ...
            new Civ(19, "Ethiopians", "Ethiopian",
                ...
                [units.cavalier, units.condottiero, units.eShotel, units.shotel, units.halbardier, units.hussar, units.heavyCamel, units.twoHandedSwordsman, units.villager],
                [upgrades.forging, upgrades.ironCasting, upgrades.blastFurnace],
                [upgrades.scaleMailArmor, upgrades.chainMailArmor, upgrades.plateMailArmor],
                [upgrades.scaleBardingArmor, upgrades.chainBardingArmor],
                {infantry: []}
            ...
            new Civ(21, "Goths", "Goth",
                ...
                [units.cavalier, units.champion, units.condottiero, units.eliteHuskarl, units.huskarl, units.halbardier, units.hussar, units.villager],
                [upgrades.forging, upgrades.ironCasting, upgrades.blastFurnace],
            ...
            new Civ(22, "Huns", "Hun",
                ...
                [units.condottiero, units.halbardier, units.hussar, units.paladin, units.twoHandedSwordsman, units.villager, units.tarkan, units.eTarkan],
                [upgrades.forging, upgrades.ironCasting, upgrades.blastFurnace],
                [upgrades.scaleMailArmor, upgrades.chainMailArmor],
                [upgrades.bloodlines, upgrades.scaleBardingArmor, upgrades.chainBardingArmor, upgrades.plateBardingArmor],
                {infantry: []}
            ...
            new Civ(23, "Incas", "Incan",
                ...
                [units.champion, units.condottiero, units.eliteEagleWarrior, units.eagleWarrior, units.eKamayuk, units.kamayuk, units.halbardier, units.xolotl, units.villager],
                [upgrades.forging, upgrades.ironCasting, upgrades.blastFurnace],
                [upgrades.scaleMailArmor, upgrades.chainMailArmor, upgrades.plateMailArmor],
                [],
                {
            ...
            new Civ(26, "Japanese", "Japanese",
                ...
                [units.cavalier, units.champion, units.condottiero, units.eSamurai, units.samurai, units.halbardier, units.villager],
                [upgrades.forging, upgrades.ironCasting, upgrades.blastFurnace],
                [upgrades.scaleMailArmor, upgrades.chainMailArmor, upgrades.plateMailArmor],
                [upgrades.bloodlines, upgrades.scaleBardingArmor, upgrades.chainBardingArmor],
                {
            ...
            new Civ(27, "Khmer", "Khmer",
                ...
                [units.cavalier, units.condottiero, units.eBattleElephant, units.battleElephant, units.halbardier, units.hussar, units.twoHandedSwordsman, units.villager],
                [upgrades.forging, upgrades.ironCasting, upgrades.blastFurnace],
                [upgrades.scaleMailArmor, upgrades.chainMailArmor],
                [upgrades.bloodlines, upgrades.scaleBardingArmor, upgrades.chainBardingArmor, upgrades.plateBardingArmor],
                {
            ...
            new Civ(29, "Lithuanians", "Lithuanian",
                ...
                [units.champion, units.condottiero, units.eLeitis, units.leitis, units.halbardier, units.hussar, units.paladin, units.villager],
                [upgrades.forging, upgrades.ironCasting, upgrades.blastFurnace],
                [upgrades.scaleMailArmor, upgrades.chainMailArmor],
                [upgrades.bloodlines, upgrades.scaleBardingArmor, upgrades.chainBardingArmor, upgrades.plateBardingArmor],
                {infantry: []}
            ...
            new Civ(30, "Magyars", "Magyar",
                ...
                [units.champion, units.condottiero, units.eMagyarHuszar, units.magyarHuszar, units.halbardier, units.hussar, units.paladin, units.villager],
                [upgrades.forging, upgrades.ironCasting, upgrades.blastFurnace],
                [upgrades.scaleMailArmor, upgrades.chainMailArmor],
                [upgrades.bloodlines, upgrades.scaleBardingArmor, upgrades.chainBardingArmor, upgrades.plateBardingArmor],
                {infantry: []}
            ...
            new Civ(32, "Malay", "Malay",
                ...
                [units.cavalier, units.condottiero, units.eBattleElephant, units.battleElephant, units.eKarambit, units.karambit, units.halbardier, units.twoHandedSwordsman, units.villager],
                [upgrades.forging, upgrades.ironCasting, upgrades.blastFurnace],
                [upgrades.scaleMailArmor, upgrades.chainMailArmor, upgrades.plateMailArmor],
            ...
            new Civ(33, "Mayans", "Mayan",
                ...
                [units.condottiero, units.eliteEagleWarrior, units.eagleWarrior, units.halbardier, units.twoHandedSwordsman, units.villager],
                [upgrades.forging, upgrades.ironCasting, upgrades.blastFurnace],
                [upgrades.scaleMailArmor, upgrades.chainMailArmor, upgrades.plateMailArmor],
                [],
                {
            ...
            new Civ(34, "Mongols", "Mongol",
                ...
                [units.cavalier, units.champion, units.condottiero, units.eSteppeLancer, units.steppeLancer, units.hussar, units.heavyCamel, units.villager, units.pikeman],
                [upgrades.forging, upgrades.ironCasting, upgrades.blastFurnace],
                [upgrades.scaleMailArmor, upgrades.chainMailArmor, upgrades.plateMailArmor],
                [upgrades.bloodlines, upgrades.scaleBardingArmor, upgrades.chainBardingArmor],
                {
            ...
            new Civ(35, "Persians", "Persian",
                ...
                [units.condottiero, units.eWarElephant, units.warElephant, units.halbardier, units.hussar, units.heavyCamel, units.paladin, units.twoHandedSwordsman, units.villager],
                [upgrades.forging, upgrades.ironCasting, upgrades.blastFurnace],
                [upgrades.scaleMailArmor, upgrades.chainMailArmor, upgrades.plateMailArmor],
                [upgrades.bloodlines, upgrades.scaleBardingArmor, upgrades.chainBardingArmor, upgrades.plateBardingArmor],
                {infantry: []}
            ...
            new Civ(38, "Slavs", "Slavic",
                ...
                [units.eBoyar, units.boyar, units.cavalier, units.champion, units.condottiero, units.halbardier, units.hussar, units.villager],
                [upgrades.forging, upgrades.ironCasting, upgrades.blastFurnace],
                [upgrades.scaleMailArmor, upgrades.chainMailArmor, upgrades.plateMailArmor],
                [upgrades.bloodlines, upgrades.scaleBardingArmor, upgrades.chainBardingArmor, upgrades.plateBardingArmor],
                {infantry: []}
            ...
            new Civ(40, "Tatars", "Tatar",
                ...
                [units.cavalier, units.condottiero, units.eSteppeLancer, units.steppeLancer, units.halbardier, units.hussar, units.heavyCamel, units.keshik, units.eKeshik, units.twoHandedSwordsman, units.villager],
                [upgrades.forging, upgrades.ironCasting, upgrades.blastFurnace],
            ...
            new Civ(41, "Teutons", "Teutonic",
                ...
                [units.champion, units.condottiero, units.eliteTeutonicKnight, units.teutonicKnight, units.halbardier, units.paladin, units.villager],
                [upgrades.forging, upgrades.ironCasting, upgrades.blastFurnace],
                [upgrades.scaleMailArmor, upgrades.chainMailArmor, upgrades.plateMailArmor],
                [upgrades.bloodlines, upgrades.scaleBardingArmor, upgrades.chainBardingArmor, upgrades.plateBardingArmor],
                {
            ...
            new Civ(43, "Vietnamese", "Vietnamese",
                ...
                [units.cavalier, units.champion, units.condottiero, units.eBattleElephant, units.battleElephant, units.halbardier, units.villager],
                [upgrades.forging, upgrades.ironCasting],
                [upgrades.scaleMailArmor, upgrades.chainMailArmor, upgrades.plateMailArmor],
                [upgrades.bloodlines, upgrades.scaleBardingArmor, upgrades.chainBardingArmor, upgrades.plateBardingArmor],
                {
            ...
            new Civ(44, "Vikings", "Viking",
                ...
                [units.eBerserk, units.berserk, units.cavalier, units.champion, units.condottiero, units.villager, units.pikeman],
                [upgrades.forging, upgrades.ironCasting, upgrades.blastFurnace],
                [upgrades.scaleMailArmor, upgrades.chainMailArmor, upgrades.plateMailArmor],
                [upgrades.scaleBardingArmor, upgrades.chainBardingArmor],
                {
